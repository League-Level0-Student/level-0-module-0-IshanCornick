	...
	public static void main(String[] args) {
		...
		while (true) {
			...
			// THE PLAYER ATTACKS THE DRAGON
				...
				// or a kick
			String attack = JOptionPane.showInputDialog(null,"Do you want to attack");
			...
			if (dragonHealth <= 0) {
				...
				// 		dragon have left.
			JOptionPane.showMessageDialog(null,"Dragon health is " + dragonHealth + ". Player health is " + playerHealth);
